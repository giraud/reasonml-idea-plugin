...
public class ExternalParsingTest extends OclParsingTestCase {
    ...
    public void test_array() {
        PsiExternalImpl e =
                (PsiExternalImpl)
                        firstOfType(
                                parseCode("external array : reactElement array -> reactElement = \"%identity\""),
                                PsiExternal.class);
    ...
    public void test_raise() {
        PsiExternalImpl e =
                (PsiExternalImpl)
                        firstOfType(parseCode("external raise : exn -> 'a = \"%raise\""), PsiExternal.class);
    ...
    public void test_operator1() {
        PsiExternalImpl e =
                (PsiExternalImpl)
                        firstOfType(
                                parseCode("external ( = ) : 'a -> 'a -> bool = \"%equal\""), PsiExternal.class);
    ...
    public void test_operator2() {
        PsiExternalImpl e =
                firstOfType(
                        parseCode("external ( <> ) : 'a -> 'a -> bool = \"%notequal\""), PsiExternalImpl.class);
    ...
    public void test_operator3() {
        PsiExternalImpl e =
                firstOfType(
                        parseCode("external ( < ) : 'a -> 'a -> bool = \"%lessthan\""), PsiExternalImpl.class);
    ...
    public void test_operator4() {
        PsiExternalImpl e =
                firstOfType(
                        parseCode("external ( > ) : 'a -> 'a -> bool = \"%greaterthan\""),
                        PsiExternalImpl.class);
    ...
    public void test_operator5() {
        PsiExternalImpl e =
                firstOfType(
                        parseCode("external ( <= ) : 'a -> 'a -> bool = \"%lessequal\""),
                        PsiExternalImpl.class);
    ...
    public void test_operator6() {
        PsiExternalImpl e =
                firstOfType(
                        parseCode("external ( >= ) : 'a -> 'a -> bool = \"%greaterequal\""),
                        PsiExternalImpl.class);
