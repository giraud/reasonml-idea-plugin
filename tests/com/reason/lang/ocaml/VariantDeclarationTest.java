...
public class VariantDeclarationTest extends OclParsingTestCase {
  ...
  public void test_constructor() {
    PsiType e =
        first(typeExpressions(parseCode("type color = | Hex of string | Rgb of int * int * int")));
  ...
  public void test_mixed() {
    PsiType e =
        first(typeExpressions(parseCode("type unfocusable = | Cannot of reason | Loose | Strict")));
