...
public class AnnotationParsingTest extends NsParsingTestCase {
  public void test_withString() {
    assertEquals(
        "@bs.module", ((PsiAnnotation) firstElement(parseCode("@bs.module(\"xyz\")"))).getName());
  }

  public void test_chaining() {
    List<PsiNamedElement> es =
        new ArrayList<>(expressions(parseCode("@bs.module(\"xyz\") @react.component")));
