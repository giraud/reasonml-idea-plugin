...
public class LetParsingTest extends ResParsingTestCase {
    ...
    public void test_scope_with_some() {
        RPsiLet let = first(letExpressions(parseCode("let l = p => { switch a { | Some(a) => a\n () | None => () }\n Some(z) }")));
    ...
    public void test_scope_with_LIdent() {
        RPsiLet let = first(letExpressions(parseCode("let l = (p) => { Js.log(p)\n returnObj }")));
    ...
    public void test_chaining_call() {
        RPsiLet e = first(letExpressions(parseCode("let x = Doc.y\n test()")));
    ...
    public void test_GH_278() {
        RPsiLet e = first(letExpressions(parseCode("let \\\"\\\\\" = Ext_path.combine"))); // let \"//" = ...
