...
public class ClassParsingTest extends BaseParsingTestCase {
    ...
    public void testClassConstraint() {
        Collection<PsiClass> classes = classExpressions(parseCode("class circle ('a) (c: 'a) = { as _; constraint 'a = #point; val mutable center = c; pub set_center = c => center = c; pub move = center#move; }"));
