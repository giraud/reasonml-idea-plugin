...
public class BsOutputListenerTest {
    ...
    public void testWarningMessage() {
        String[] output
                = new String[]{"[3/3] Building File.cmj\n",
                "\n",
                "  Warning number 44\n",
        ...
        BsOutputListener.LineProcessor outputListener = new BsOutputListener.LineProcessor();

        for (String line : output) {
            outputListener.onRawTextAvailable(line);
        }

        List<OutputInfo> allErrors = outputListener.m_bsbInfo;
        ...
        assertEquals("this open statement shadows the value identifier floor (which is later used)", info.message);
    }
    ...
    public void testError() {
        ...
        assertEquals("The value dfSetHours can't be found. Hint: Did you mean dfAddHours?", info.message);
    }
