...
public class BsPlatformTest {
    ...
    public void testFindBsbExecutable_platformSpecificBinary() {
        ...
        MockVirtualFile mockBsbExecutable = MockVirtualFile.file(BSB_EXE_NAME + ".exe");
        MockVirtualFile mockPlatformDirectory = MockVirtualFile.dir(BsPlatform.getOsBsPrefix(), mockBsbExecutable);
        MockVirtualFile mockBsPlatformDirectory = MockVirtualFile.dir(BS_PLATFORM_NAME, mockPlatformDirectory);
    ...
    public void testFindBsbExecutable_platformAgnosticWrapper() {
        ...
        String bsbWrapperFilename = BSB_EXE_NAME + BsPlatform.getOsBinaryWrapperExtension();
