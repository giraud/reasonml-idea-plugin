...
public class BsPlatformTest {
  ...
  public void testFindBsPlatformDirectory() {
    ...
    MockVirtualFile mockNodeModulesDirectory =
        MockVirtualFile.dir("node_modules", mockBsPlatformDirectory);
    MockVirtualFile mockSourceDirectory =
        MockVirtualFile.dir(MOCK_ROOT, mockBsConfigFile, mockNodeModulesDirectory);
    Optional<VirtualFile> bsPlatformDirectory =
        BsPlatform.findBsPlatformDirectory(mockProject, mockSourceDirectory);
  ...
  public void testFindBsbExecutable_platformSpecificBinary() {
    ...
    MockVirtualFile mockBsPlatformDirectory =
        MockVirtualFile.dir(BS_PLATFORM_DIRECTORY_NAME, mockPlatformDirectory);
    MockVirtualFile mockNodeModulesDirectory =
        MockVirtualFile.dir("node_modules", mockBsPlatformDirectory);

    MockVirtualFile mockBsConfigFile = MockVirtualFile.file(BS_CONFIG_FILENAME);

    MockVirtualFile mockRootDirectory =
        MockVirtualFile.dir(
            MOCK_ROOT, mockBsConfigFile, mockNodeModulesDirectory, mockSourceDirectory);
  ...
  public void testFindBsbExecutable_platformAgnosticWrapper() {
    ...
    MockVirtualFile mockBsPlatformDirectory =
        MockVirtualFile.dir(BS_PLATFORM_DIRECTORY_NAME, mockBsbExecutableWrapper);
    MockVirtualFile mockNodeModulesDirectory =
        MockVirtualFile.dir("node_modules", mockBsPlatformDirectory);
    ...
    Optional<VirtualFile> bsbExecutableWrapper =
        BsPlatform.findBsbExecutable(mockProject, mockBsPlatformDirectory);
