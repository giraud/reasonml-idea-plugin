...
public class OclQNameFinderTest extends ORBasePlatformTestCase {
    ...
    public void testLetBinding() {
        ...
        Set<String> paths = new OclQNameFinder().extractPotentialPaths(myFixture.getElementAtCaret(), false);
    ...
    public void testLocalModuleAliasResolution() {
        ...
        Set<String> paths = new OclQNameFinder().extractPotentialPaths(myFixture.getElementAtCaret(), true);
        assertSameElements(paths, "A.Belt.Option", "Belt.Option");
    }
}
