...
public class JsObjectCompletionTest extends LightPlatformCodeInsightFixtureTestCase {
    ...
    public void testDeepJsFieldCompletion() {
        myFixture.configureByText("JsObj.re", "let oo = {\"first\": {\"deep\": true},\"deep\": {\"asd\": 1} }");
        myFixture.configureByText(RmlFileType.INSTANCE, "open JsObj; oo##deep##<caret>");
    ...
    public void testComposedJsObject2() {
        myFixture.configureByText("JsObj2.re", "let o = {\"f22\": 222}; let oo = {\"f1\": {\"f11\": 111}, \"f2\": o,\"f3\": {\"f33\": 333} }");
        myFixture.configureByText("JsObj.re", "let oo = {\"f1\": {\"f11\": 111}, \"f2\": JsObj2.o,\"f3\": {\"f33\": 333} }");
        myFixture.configureByText(RmlFileType.INSTANCE, "open JsObj; oo##f2##<caret>");
    ...
    public void testComposedJsObject3() {
        myFixture.configureByText("JsObj.re", "let o = {\"ooo\": o, \"f22\": 222}; let oo = {\"f1\": o, \"f2\": o,\"f3\": {\"f33\": 333} }");
        myFixture.configureByText(RmlFileType.INSTANCE, "open JsObj; oo##f2##<caret>");
