...
public class ODocTest extends BaseParsingTestCase {
  ...
  public void testParapgrah() {
    ...
    assertEquals(
        "<p> 1st paraph multiline </p> <p>Another parah </p>",
        new ODocConverter(new ODocLexer()).convert(comment));
  }
  ...
  public void testEmphasis() {
    ...
    assertEquals(
        "<p> <em>See</em> other </p>", new ODocConverter(new ODocLexer()).convert(comment));
  }

  public void testOList() {
    String comment = "(** {ol {- l1} {-l2}} *)\n";
    assertEquals(
        "<p> <ol><li>l1</li> <li>l2</li></ol> </p>",
        new ODocConverter(new ODocLexer()).convert(comment));
  }
  ...
  public void testLink() {
    ...
    assertEquals(
        "<p> <a href=\"http://unicode.org/glossary/#unicode_scalar_value\">scalar value</a> </p>",
        new ODocConverter(new ODocLexer()).convert(comment));
  }
}
