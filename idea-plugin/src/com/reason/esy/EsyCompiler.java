...
public class EsyCompiler implements Compiler {
    ...
    public void runDefault(
            @NotNull VirtualFile file, @Nullable Compiler.ProcessTerminated onProcessTerminated) {
    ...
    public void run(@NotNull VirtualFile file, @NotNull CliType cliType, @Nullable ProcessTerminated onProcessTerminated) {
        ...
        ProcessHandler processHandler = process.create(file, cliType, onProcessTerminated);
    ...
    public ConsoleView getConsoleView() {
        ...
        Content windowContent =
                esyToolWindow == null ? null : esyToolWindow.getContentManager().getContent(0);
