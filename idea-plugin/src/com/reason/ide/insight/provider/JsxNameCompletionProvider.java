...
public class JsxNameCompletionProvider {
    ...
    for (PsiModule module : modules) {
      ...
      if (moduleName != null) {
        FileBase containingFile =
            module instanceof FileBase ? (FileBase) module : (FileBase) module.getContainingFile();
  ...
  private static void insertTagNameHandler(
      @NotNull Project project, @NotNull InsertionContext context, @NotNull String tagName) {
