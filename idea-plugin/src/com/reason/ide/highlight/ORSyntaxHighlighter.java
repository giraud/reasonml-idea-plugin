...
public class ORSyntaxHighlighter extends SyntaxHighlighterBase {
  ...
  private static final Set<IElementType> NS_KEYWORD_TYPES =
      of(
          NsTypes.INSTANCE.OPEN,
          NsTypes.INSTANCE.MODULE,
          NsTypes.INSTANCE.FUN,
          NsTypes.INSTANCE.LET,
          NsTypes.INSTANCE.TYPE,
          NsTypes.INSTANCE.INCLUDE,
          NsTypes.INSTANCE.EXTERNAL,
          NsTypes.INSTANCE.IF,
          NsTypes.INSTANCE.ELSE,
          NsTypes.INSTANCE.ENDIF,
          NsTypes.INSTANCE.SWITCH,
          NsTypes.INSTANCE.TRY,
          NsTypes.INSTANCE.RAISE,
          NsTypes.INSTANCE.FOR,
          NsTypes.INSTANCE.IN,
          NsTypes.INSTANCE.TO,
          NsTypes.INSTANCE.BOOL_VALUE,
          NsTypes.INSTANCE.REF,
          NsTypes.INSTANCE.EXCEPTION,
          NsTypes.INSTANCE.WHEN,
          NsTypes.INSTANCE.AND,
          NsTypes.INSTANCE.REC,
          NsTypes.INSTANCE.WHILE,
          NsTypes.INSTANCE.ASR,
          NsTypes.INSTANCE.CLASS,
          NsTypes.INSTANCE.CONSTRAINT,
          NsTypes.INSTANCE.DOWNTO,
          NsTypes.INSTANCE.FUNCTOR,
          NsTypes.INSTANCE.INHERIT,
          NsTypes.INSTANCE.INITIALIZER,
          NsTypes.INSTANCE.LAND,
          NsTypes.INSTANCE.LOR,
          NsTypes.INSTANCE.LSL,
          NsTypes.INSTANCE.LSR,
          NsTypes.INSTANCE.LXOR,
          NsTypes.INSTANCE.METHOD,
          NsTypes.INSTANCE.MOD,
          NsTypes.INSTANCE.NEW,
          NsTypes.INSTANCE.NONREC,
          NsTypes.INSTANCE.OR,
          NsTypes.INSTANCE.PRIVATE,
          NsTypes.INSTANCE.VIRTUAL,
          NsTypes.INSTANCE.VAL,
          NsTypes.INSTANCE.PUB,
          NsTypes.INSTANCE.PRI,
          NsTypes.INSTANCE.OBJECT,
          NsTypes.INSTANCE.MUTABLE,
          NsTypes.INSTANCE.UNIT,
          NsTypes.INSTANCE.WITH,
          NsTypes.INSTANCE.DIRECTIVE_IF,
          NsTypes.INSTANCE.DIRECTIVE_ELSE,
          NsTypes.INSTANCE.DIRECTIVE_ELIF,
          NsTypes.INSTANCE.DIRECTIVE_END,
          NsTypes.INSTANCE.DIRECTIVE_ENDIF);
  ...
  private static final Set<IElementType> NS_OPERATION_SIGN_TYPES =
      of(
          ...
          NsTypes.INSTANCE.PIPE_FORWARD,
          NsTypes.INSTANCE.EQEQEQ,
          NsTypes.INSTANCE.EQEQ,
          NsTypes.INSTANCE.EQ,
          NsTypes.INSTANCE.NOT_EQEQ,
          NsTypes.INSTANCE.NOT_EQ,
          NsTypes.INSTANCE.DIFF,
          NsTypes.INSTANCE.COLON,
          NsTypes.INSTANCE.SINGLE_QUOTE,
          NsTypes.INSTANCE.DOUBLE_QUOTE,
          NsTypes.INSTANCE.CARRET,
          NsTypes.INSTANCE.PLUSDOT,
          NsTypes.INSTANCE.MINUSDOT,
          NsTypes.INSTANCE.SLASHDOT,
          NsTypes.INSTANCE.STARDOT,
          NsTypes.INSTANCE.PLUS,
          NsTypes.INSTANCE.MINUS,
          NsTypes.INSTANCE.SLASH,
          NsTypes.INSTANCE.STAR,
          NsTypes.INSTANCE.PERCENT,
          NsTypes.INSTANCE.PIPE,
          NsTypes.INSTANCE.ARROBASE,
          NsTypes.INSTANCE.SHARP,
          NsTypes.INSTANCE.SHARPSHARP,
          NsTypes.INSTANCE.QUESTION_MARK,
          NsTypes.INSTANCE.EXCLAMATION_MARK,
          NsTypes.INSTANCE.LT_OR_EQUAL,
          NsTypes.INSTANCE.GT_OR_EQUAL,
          NsTypes.INSTANCE.AMPERSAND,
          NsTypes.INSTANCE.LEFT_ARROW,
          NsTypes.INSTANCE.RIGHT_ARROW,
          NsTypes.INSTANCE.COLON_EQ,
          NsTypes.INSTANCE.COLON_GT,
          NsTypes.INSTANCE.GT,
          NsTypes.INSTANCE.GT_BRACE,
          NsTypes.INSTANCE.GT_BRACKET,
          NsTypes.INSTANCE.BRACKET_GT,
          NsTypes.INSTANCE.BRACKET_LT,
          NsTypes.INSTANCE.BRACE_LT,
          NsTypes.INSTANCE.DOTDOT);

  private static final Set<IElementType> NS_OPTIONS_TYPES =
      of(NsTypes.INSTANCE.NONE, NsTypes.INSTANCE.SOME);
  ...
  private static final TextAttributesKey[] TYPE_ARGUMENT_KEYS =
      new TextAttributesKey[] {TYPE_ARGUMENT_};
  private static final TextAttributesKey[] POLY_VARIANT_KEYS =
      new TextAttributesKey[] {POLY_VARIANT_};
  ...
  private static final TextAttributesKey[] OPERATION_SIGN_KEYS =
      new TextAttributesKey[] {OPERATION_SIGN_};
  ...
  public Lexer getHighlightingLexer() {
    return m_types instanceof RmlTypes
        ? new RmlLexer()
        : m_types instanceof NsTypes ? new NsLexer() : new OclLexer();
  }
