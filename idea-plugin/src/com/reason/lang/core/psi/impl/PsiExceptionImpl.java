...
public class PsiExceptionImpl extends PsiTokenStub<ORTypes, PsiExceptionStub>
    implements PsiException {
  ...
  public PsiExceptionImpl(
      @NotNull ORTypes types, @NotNull PsiExceptionStub stub, @NotNull IStubElementType nodeType) {
  ...
  public String getName() {
    PsiElement nameIdentifier =
        ORUtil.findImmediateFirstChildOfClass(this, PsiUpperIdentifier.class);
