...
public class NsFileStubElementType extends IStubFileElementType<NsFileStub> {
  ...
  @Override
  public void serialize(@NotNull NsFileStub stub, @NotNull StubOutputStream dataStream)
      throws IOException {
  ...
  @NotNull
  @Override
  public NsFileStub deserialize(@NotNull StubInputStream dataStream, StubElement parentStub)
      throws IOException {
