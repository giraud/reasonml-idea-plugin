  ...
  public static boolean apply(
    ...
    try {
      ...
      java.nio.file.Files.move(
          partFile.toPath(), targetFile.toPath(), StandardCopyOption.ATOMIC_MOVE);
      ...
      Notifications.Bus.notify(
          new ORNotification("Reason", "Downloaded " + targetFile, NotificationType.INFORMATION));

      return true;
    } catch (IOException e) {
      Notifications.Bus.notify(
          new ORNotification(
              "Reason", "Can't download " + targetFile + "\n" + e, NotificationType.ERROR));
      return false;
    }
  }
}
