...
public class ReasonMLTypeExprImpl extends ASTWrapperPsiElement implements ReasonMLTypeExpr {
  ...
  @Override
  @NotNull
  public List<ReasonMLAttribute> getAttributeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ReasonMLAttribute.class);
  }
  ...
  @Override
  @NotNull
  public List<ReasonMLPolyType> getPolyTypeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ReasonMLPolyType.class);
  }
  ...
  @Override
  @NotNull
  public List<ReasonMLTypeConstrName> getTypeConstrNameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ReasonMLTypeConstrName.class);
  }
