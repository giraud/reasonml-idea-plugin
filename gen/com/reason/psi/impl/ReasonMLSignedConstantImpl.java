...
public class ReasonMLSignedConstantImpl extends ASTWrapperPsiElement implements ReasonMLSignedConstant {

  public ReasonMLSignedConstantImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ReasonMLVisitor visitor) {
    visitor.visitSignedConstant(this);
  }
