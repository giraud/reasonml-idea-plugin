...
public class ReasonMLPolyTypeImpl extends ASTWrapperPsiElement implements ReasonMLPolyType {

  public ReasonMLPolyTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ReasonMLVisitor visitor) {
    visitor.visitPolyType(this);
  }
