...
public class ReasonMLParser implements PsiParser, LightPsiParser {
  ...
  // pattern_matching+
  private static boolean expr_6_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "expr_6_3")) return false;
    boolean r;
    Marker m = enter_section_(b);
    ...
    while (r) {
      ...
      if (!empty_element_parsed_guard_(b, "expr_6_3", c)) break;
      c = current_position_(b);
    }
    exit_section_(b, m, null, r);
    return r;
  ...
  // LPAREN expr RPAREN
  private static boolean recursive_expr_1_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "recursive_expr_1_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, LPAREN);
    r = r && expr(b, l + 1);
