...
//    }
//    else if (t == OPEN_EXPRESSION) {
//      r = open_expression(b, 0);
//    }
//    else if (t == PARAMETER) {
//      r = parameter(b, 0);
//    }
...
//  public static boolean open_expression(PsiBuilder b, int l) {
//    if (!recursion_guard_(b, l, "open_expression")) return false;
...
//    r = r && consumeToken(b, SEMI);
//    exit_section_(b, m, OPEN_EXPRESSION, r);
//    return r;
//  }
//
//  /* ********************************************************** */
