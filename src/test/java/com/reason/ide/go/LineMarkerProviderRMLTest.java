...
public class LineMarkerProviderRMLTest extends ORBasePlatformTestCase {
    ...
    public void test_let() {
        configureCode("A.re", "module type I = {\n" +
                "  let x: int;\n" +
                "};\n" +
                "module M1 : I = {\n" +
                "  let x = 1;\n" +
    ...
    public void test_external_files() {
        configureCode("A.rei", "external t: int = \"\";");
        configureCode("A.re", "external t: int = \"\";");
    ...
    public void test_module() {
        configureCode("A.re", "module type Intf = {};\n" +
                "module Impl : Intf = {};");
    ...
    public void test_exception_files() {
        configureCode("A.rei", "exception X;");
        configureCode("A.re", "exception X;");
