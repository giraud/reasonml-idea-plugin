...
public class ORSignatureTest extends LightJavaCodeInsightTestCase {
    ...
    public void testOcamlMultiFun() {
        RPsiSignature sig = makeSignature(OCL, "unit -> string -> float -> unit");
    ...
    public void testOCamlObject() {
        RPsiSignature sig = makeSignature(OCL, "<a:string> -> string");
    ...
    public void testOCamlJsObject() {
        RPsiSignature sig = makeSignature(OCL, "<a:string; b:int> Js.t -> string");
    ...
    public void testOcamJsJsObject() {
        RPsiSignature sig = makeSignature(OCL, "string -> < a : string; b : < b1 : string; b2 : string > Js.t > Js.t");
    ...
    private @NotNull RPsiSignature makeSignature(@NotNull Language lang, String sig) {
        ...
        return PsiTreeUtil.findChildOfType(psiFile, RPsiSignature.class);
    }
}
