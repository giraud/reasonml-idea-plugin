...
public class OCamlBinaryRootEditHandler extends ModuleSourceRootEditHandler<OCamlBinaryRootProperties> {
  ...
  @Nullable
  @Override
  public JComponent createPropertiesEditor(
      @NotNull final SourceFolder folder,
    ...
    final IconActionComponent iconComponent =
        new IconActionComponent(
            ...
            () -> {
              OCamlBinaryRootProperties properties =
                  folder.getJpsElement().getProperties(OCamlBinaryRootType.BINARY);
              assert properties != null;
              OCamlBinaryRootEditHandler.ResourceRootPropertiesDialog dialog =
                  new OCamlBinaryRootEditHandler.ResourceRootPropertiesDialog(
  ...
  private static class ResourceRootPropertiesDialog extends DialogWrapper {
    @NotNull private final JTextField myRelativeOutputPathField;
    @NotNull private final JCheckBox myIsGeneratedCheckBox;
    private final JPanel myMainPanel;
    @NotNull private final OCamlBinaryRootProperties myProperties;

    private ResourceRootPropertiesDialog(
        @NotNull JComponent parentComponent, @NotNull OCamlBinaryRootProperties properties) {
      super(parentComponent, true);
      myProperties = properties;
      setTitle(ProjectBundle.message("module.paths.edit.properties.title"));
      myRelativeOutputPathField = new JTextField();
      myIsGeneratedCheckBox =
          new JCheckBox(UIUtil.replaceMnemonicAmpersand("For &generated resources"));
      myMainPanel =
    ...
    private static String normalizePath(@NotNull String path) {
      return StringUtil.trimEnd(
          StringUtil.trimStart(FileUtil.toSystemIndependentName(path.trim()), "/"), "/");
    }
