...
public class ORSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    private static final Set<IElementType> RML_OPERATION_SIGN_TYPES = of(
            ...
            RmlTypes.INSTANCE.QUOTE, RmlTypes.INSTANCE.CARRET, RmlTypes.INSTANCE.PLUSDOT, RmlTypes.INSTANCE.MINUSDOT,
    ...
    private static final Set<IElementType> OCL_OPERATION_SIGN_TYPES = of(
            ...
            OclTypes.INSTANCE.QUOTE, OclTypes.INSTANCE.CARRET, OclTypes.INSTANCE.PLUSDOT, OclTypes.INSTANCE.MINUSDOT,
