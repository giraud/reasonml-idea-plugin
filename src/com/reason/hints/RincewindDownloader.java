...
public class RincewindDownloader extends Task.Backgroundable {
  ...
  public void run(@NotNull ProgressIndicator indicator) {
    ...
    InsightManagerImpl insightManager =
        (InsightManagerImpl) ServiceManager.getService(myProject, InsightManager.class);
              ...
              dumbService.runReadActionInSmartMode(
                  () -> {
                    ...
                    for (VirtualFile openedFile : openedFiles) {
                      ...
                      PsiFile cmtFile =
                          ORFileManager.findCmtFileFromSource(
                              myProject, openedFile.getNameWithoutExtension());
                      if (cmtFile != null) {
                        Path cmtPath =
