...
public class BsConfigReader {
    ...
    static BsConfig parse(@NotNull String content) {
        ...
        if (topElement.isJsonObject()) {
            ...
            JsonObject reasonProp = reason != null && reason.isJsonObject() ? top.getAsJsonObject("reason") : null;
            if (reasonProp != null) {
    ...
    private static void readSources(@NotNull JsonElement value, @NotNull String type, @NotNull Set<String> sources) {
