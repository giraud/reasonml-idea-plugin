...
public class MlSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    private static final Set<IElementType> RML_KEYWORD_TYPES = of(
            ...
            RmlTypes.INSTANCE.INCLUDE, RmlTypes.INSTANCE.EXTERNAL, RmlTypes.INSTANCE.IF_STATEMENT, RmlTypes.INSTANCE.ELSE, RmlTypes.INSTANCE.SWITCH,
    ...
    private static final Set<IElementType> OCL_KEYWORD_TYPES = of(
            ...
            OclTypes.INSTANCE.INCLUDE, OclTypes.INSTANCE.EXTERNAL, OclTypes.INSTANCE.IF_STATEMENT, OclTypes.INSTANCE.ELSE, OclTypes.INSTANCE.SWITCH,
