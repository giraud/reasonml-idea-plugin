...
public class ModuleAliasedIndex extends StringStubIndexExtension<RPsiModule> {
    @Override
    ...
    public static @NotNull Collection<RPsiModule> getElements(@NotNull String key, @NotNull Project project, @Nullable GlobalSearchScope scope) {
        return StubIndex.getElements(IndexKeys.MODULES_ALIASED, key, project, scope, RPsiModule.class);
    }
}
