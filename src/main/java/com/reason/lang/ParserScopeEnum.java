...
public enum ParserScopeEnum {
    ...
    functionParameterSignature, patternMatchConstructor, functionParameterNamedSignature, recordFieldSignature, maybeRecordUsage, recordUsage, recordFieldValue, signatureItem, name
}
