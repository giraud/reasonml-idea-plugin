...
public enum ParserScopeEnum {
    ...
    valNamedSymbol, struct, matchException, beginScope, ifElseStatement, bracketGt, moduleFunctorNamed, moduleTypeDeclaration, moduleTypeNamed, moduleTypeNamedEq, moduleDeclaration, name
}
