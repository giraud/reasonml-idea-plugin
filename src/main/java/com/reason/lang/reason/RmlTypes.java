...
public class RmlTypes extends MlTypes {
    ...
    private RmlTypes() {
        ...
        LET_EXPRESSION = new PsiLetStubElementType("LET_EXPRESSION");
        MACRO_EXPRESSION = new RmlElementType("MACRO_EXPRESSION");
        MACRO_NAME = new RmlElementType("MACRO_NAME");
        MODULE_EXPRESSION = new ModuleStubElementType("MODULE_EXPRESSION");
        ...
        TYPE_EXPRESSION = new PsiTypeElementType("TYPE_EXPRESSION");
        VAL_EXPRESSION = new PsiLetStubElementType("VAL_EXPRESSION");
