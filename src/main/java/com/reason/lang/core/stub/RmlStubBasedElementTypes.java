...
public interface RmlStubBasedElementTypes {
    ...
    IStubElementType<RsiClassStub, RPsiClass> C_CLASS_DECLARATION = new RPsiClassStubElementType("C_CLASS_DECLARATION", RmlLanguage.INSTANCE);
    IStubElementType<RsiClassMethodStub, RPsiClassMethod> C_CLASS_METHOD = new RPsiClassMethodStubElementType("C_CLASS_METHOD", RmlLanguage.INSTANCE);
    ...
    IStubElementType<RsiRecordFieldStub, RPsiRecordField> C_RECORD_FIELD = new RPsiRecordFieldStubElementType("C_RECORD_FIELD", RmlLanguage.INSTANCE);
