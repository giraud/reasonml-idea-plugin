...
public class RsiRecordFieldStubElementType extends ORStubElementType<RsiRecordFieldStub, RPsiRecordField> {
    public RsiRecordFieldStubElementType(@NotNull String name, @NotNull Language language) {
        super(name, language);
    }
